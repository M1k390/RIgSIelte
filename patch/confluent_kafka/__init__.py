...
def _delvewheel_init_patch_60438943116():
	import os
	import sys

	# PATCH
	# Use internal files if running in executable file
	# Lib files need to be injected by Pyinstaller
	if getattr(sys, 'frozen', False) and hasattr(sys, '_MEIPASS'):
		libs_dir= os.path.abspath(os.path.join(sys._MEIPASS, 'confluent_kafka.libs'))
	else:
...
_delvewheel_init_patch_60438943116()
del _delvewheel_init_patch_60438943116
